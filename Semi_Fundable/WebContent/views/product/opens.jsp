...
<%@ page import ="java.util.ArrayList,com.fun.product.model.vo.Image" %>
   ...
   ArrayList<Image> sList = (ArrayList<Image>)request.getAttribute("sList");
   %>
...
<span style="font-size:20px; margin-left:30px;">오픈 예정 중인 프로젝트</span>
</div>
          ...
          <input type="hidden" name="productNo" value="<%= i.getProductNo()%>">
            ...
            <td class="product ff<%= i.getUserNo() %>">
               <div class="imagetextboxc">
                  <button type="submit">
                     <img style="border-radius:8px;" src="<%= contextPath%>/<%=i.getFilePath()%><%=i.getChangeName()%>" alt="" >
                  </button>
